...
const MESSAGES = {
  en: {
    ...
    'adopt.name': 'What should Billy call this account?',
    'adopt.adopted': 'Added "{name}" — it keeps using {dir}.',
  ...
  it: {
    ...
    'adopt.name': 'Come vuoi chiamare questo account?',
    'adopt.adopted': 'Aggiunto "{name}" — continua a usare {dir}.',

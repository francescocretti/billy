...
const MESSAGES = {
  en: {
    ...
    'adopt.title': 'Existing Claude Code setup found',
    'adopt.dir': 'Directory',
    'adopt.account': 'Logged in as',
    'adopt.projects': 'Projects',
    'adopt.question': 'What should Billy do with it?',
    'adopt.adopt': 'Use it as your first account',
    'adopt.adoptHint': 'nothing moves; plain `claude` keeps working as this account',
    'adopt.move': 'Move it into ~/.claude-<name>',
    'adopt.moveHint': "Billy's convention; plain `claude` starts fresh and empty",
    'adopt.skip': 'Leave it alone',
    'adopt.skipHint': 'new accounts start from scratch',
    'adopt.name': 'Name for this account',
    'adopt.targetExists': '{dir} already exists — move it or pick another name first.',
    'adopt.moveWarning': 'Move {from} to {to}? Anything that runs `claude` without Billy will start from an empty config, and you may have to log in again.',
    'adopt.moved': '"{name}" now lives in {dir}.',
    'adopt.adopted': '"{name}" now points at {dir}.',
    'adopt.moveError': 'Move failed: {message}',
    'adopt.brokenLinks': 'These shared plugins pointed into the old location and are now broken: {list}',
  ...
  it: {
    ...
    'adopt.title': 'Trovata una configurazione Claude Code esistente',
    'adopt.dir': 'Cartella',
    'adopt.account': 'Account',
    'adopt.projects': 'Progetti',
    'adopt.question': 'Cosa vuoi che Billy ne faccia?',
    'adopt.adopt': 'Usala come primo account',
    'adopt.adoptHint': 'non sposta nulla; `claude` da solo resta questo account',
    'adopt.move': 'Spostala in ~/.claude-<nome>',
    'adopt.moveHint': 'convenzione di Billy; `claude` da solo riparte da zero',
    'adopt.skip': 'Lasciala dov’è',
    'adopt.skipHint': 'i nuovi account partono da zero',
    'adopt.name': 'Nome di questo account',
    'adopt.targetExists': '{dir} esiste già — spostala o scegli un altro nome.',
    'adopt.moveWarning': 'Spostare {from} in {to}? Tutto ciò che lancia `claude` senza Billy ripartirà da una config vuota, e potresti dover rifare il login.',
    'adopt.moved': '"{name}" ora sta in {dir}.',
    'adopt.adopted': '"{name}" ora punta a {dir}.',
    'adopt.moveError': 'Spostamento fallito: {message}',
    'adopt.brokenLinks': 'Questi plugin condivisi puntavano alla vecchia posizione e ora sono rotti: {list}',
